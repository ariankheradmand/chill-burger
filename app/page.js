...
export default function Home() {
  ...
  return (
    <div className="font-lalezar flex flex-col items-center justify-center gap-6 overflow-hidden relative">
      <Image src={'/background-texture.svg'} alt="background texture" width={2000} height={2000} className="opacity-70 fixed w-screen h-screen left-0 bottom-px  object-cover" />
      <Navbar />
