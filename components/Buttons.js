      ...
      <div className="flex-cc gap-2 w-11/12 sm:w-90 mt-10">
        <div className="flex items-center justify-between gap-2 w-full">
          <button
            ...
            id="left-b"
            className="w-5/12 text-white bg-primary-red py-3 shadow-rb rounded-[10px] flex-rc gap-2"
          >
            <Hamburger />
            برگر ها
          </button>
          <button
            ...
            id="right-b"
            className="w-5/12 opacity-0 bg-Secondary-lightblue text-white py-3 shadow-rb rounded-[10px] flex-rc gap-2"
          >
            <Salad />
            سالاد ها
          </button>
