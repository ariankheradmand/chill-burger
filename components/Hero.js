...
function Hero() {
  return (
    <div className=" flex-cc gap-6 w-full text-[12px]">
      <span className="w-11/12 h-38 relative flex-cc bg-black rounded-[20px] shadow-md overflow-hidden ">
        <Image
   ...
   <span className="w-11/12 h-38 relative flex-cc bg-black rounded-[20px] shadow-md overflow-hidden">
      ...
      </span><span className="w-11/12 h-38 relative flex-cc bg-black rounded-[20px] shadow-md overflow-hidden">
        <Image
          className="object-contain "
          width={500}
          height={150}
